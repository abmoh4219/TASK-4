...
| GET `/account/delete`                        | yes     | HTTP with mocking                     | `UncoveredEndpointsTest`                                                             | `UncoveredEndpointsTest#accountDeleteGetRenders`                                                                                                                      |
...
| GET `/orders`                                | yes     | HTTP with mocking                     | `OrderApiTest`                                                                       | `OrderApiTest#testOrdersListPageRenders`                                                                                                                              |
...
| POST `/orders/{id}/cancel`                   | yes     | HTTP with mocking                     | `OrderApiTest`                                                                       | `OrderApiTest#testCancelOrderSuccess`                                                                                                                                 |
...
| GET `/grades`                                | yes     | HTTP with mocking                     | `UncoveredEndpointsTest`                                                             | `UncoveredEndpointsTest#gradesIndexFacultyRendersList`                                                                                                                |
...
| GET `/grades/{courseId}/entry`               | yes     | HTTP with mocking                     | `GradeApiTest`                                                                       | `GradeApiTest#testStudentCannotEnterGrade`                                                                                                                            |
...
| POST `/evaluations/{cycleId}/indicators`     | yes     | HTTP with mocking                     | `UncoveredEndpointsTest`                                                             | `UncoveredEndpointsTest#evaluationsCreateAndDetailAndIndicatorAndOpenAndSubmit`                                                                                       |
| POST `/evaluations/{cycleId}/open`           | yes     | HTTP with mocking                     | `UncoveredEndpointsTest`                                                             | `UncoveredEndpointsTest#evaluationsCreateAndDetailAndIndicatorAndOpenAndSubmit`                                                                                       |
| POST `/evaluations/{cycleId}/submit`         | yes     | HTTP with mocking                     | `UncoveredEndpointsTest`                                                             | `UncoveredEndpointsTest#evaluationsCreateAndDetailAndIndicatorAndOpenAndSubmit`                                                                                       |
| POST `/evaluations/{cycleId}/evidence`       | yes     | HTTP with mocking                     | `EvaluationApiTest`                                                                  | `EvaluationApiTest#testUploadEvidence`                                                                                                                                |
| GET `/evaluations/{cycleId}/review`          | yes     | HTTP with mocking                     | `UncoveredEndpointsTest`                                                             | `UncoveredEndpointsTest#evaluationsReviewAndApprove`                                                                                                                  |
| POST `/evaluations/{cycleId}/approve`        | yes     | HTTP with mocking                     | `UncoveredEndpointsTest`                                                             | `UncoveredEndpointsTest#evaluationsReviewAndApprove`                                                                                                                  |
...
| POST `/admin/users`                          | yes     | HTTP with mocking                     | `CoverageBoostTest`                                                                  | `CoverageBoostTest#adminCreateUserHappy`                                                                                                                              |
| POST `/admin/users/{id}/deactivate`          | yes     | HTTP with mocking                     | `CoverageBoostTest`                                                                  | `CoverageBoostTest#adminDeactivateNonexistentUser`                                                                                                                    |
| GET `/admin/import`                          | yes     | HTTP with mocking                     | `CoverageBoostTest`                                                                  | `CoverageBoostTest#adminImportPage`                                                                                                                                   |
| POST `/admin/import/csv`                     | yes     | HTTP with mocking                     | `CoverageBoostTest`                                                                  | `CoverageBoostTest#adminImportCsvViaForm`                                                                                                                             |
...
| GET `/api/notifications/list`                | yes     | HTTP with mocking                     | `CoverageBoostTest`                                                                  | `CoverageBoostTest#notificationList`                                                                                                                                  |
| POST `/api/notifications/mark-read`          | yes     | HTTP with mocking                     | `CoverageBoostTest`                                                                  | `CoverageBoostTest#notificationMarkRead`                                                                                                                              |
...
| GET `/api/v1/courses/{id}`                   | yes     | HTTP with mocking                     | `CoverageBoostTest`                                                                  | `CoverageBoostTest#courseApiGetOne`                                                                                                                                   |
| GET `/api/v1/courses/{id}/grades`            | yes     | HTTP with mocking                     | `CoverageBoostTest`, `SecurityHardeningTest`                                         | `CoverageBoostTest#courseApiGradesAdmin`; `SecurityHardeningTest#testFacultyBlockedOnCourseApiGradesWithoutScope`                                                     |
...
| GET `/api/v1/retry/jobs/{id}`                | yes     | HTTP with mocking                     | `UncoveredEndpointsTest`                                                             | `UncoveredEndpointsTest#apiV1RetryJobByIdReturnsStoredFields`                                                                                                         |
...
| GET `/api/v1/students/{id}/grades`           | yes     | HTTP with mocking                     | `UncoveredEndpointsTest`                                                             | `UncoveredEndpointsTest#apiV1StudentGradesSelfOk`                                                                                                                     |
| GET `/api/v1/grades`                         | yes     | HTTP with mocking                     | `SecurityHardeningTest`                                                              | `SecurityHardeningTest#testGradeApiRbacReviewerAllowed`                                                                                                               |
| GET `/api/v1/grades/student/{studentId}`     | yes     | HTTP with mocking                     | `SecurityHardeningTest`                                                              | `SecurityHardeningTest#testStudentCanReadOwnGradesViaByStudent`                                                                                                       |
| GET `/api/v1/grades/course/{courseId}`       | yes     | HTTP with mocking                     | `SecurityHardeningTest`                                                              | `SecurityHardeningTest#testFacultyWithoutRecordedComponentsBlockedOnCourse`                                                                                           |
| POST `/api/v1/grades/recalculate/{courseId}` | yes     | HTTP with mocking                     | `UncoveredEndpointsTest`                                                             | `UncoveredEndpointsTest#apiV1RecalculateCourseGradesAsAdmin`                                                                                                          |
...
- **True API coverage %:** $\frac{41}{68}\times 100 = 60.29\%$
...
- Balance is now materially better, though true no-mock API ratio remains moderate.
...
- - True no-mock API coverage increased materially (60.29%) with `RealHttpWriteTest`.
...
- - Several endpoints are still predominantly validated via `MockMvc` in addition to real-HTTP checks.
- - Some flows still rely on status/redirect assertions more than exhaustive response-contract assertions.

## Key Gaps

1. Expand response-contract depth (field-level schema assertions) in additional endpoints currently asserting mainly status/redirect.
2. Add dedicated unit coverage for `ImportExportService` and `AuthEventHandlers`.
3. Broaden true no-mock coverage for remaining security-negative scenarios where only mocked-context checks exist.
